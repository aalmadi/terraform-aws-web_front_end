...
| <a name="input_instance_type"></a> [instance\_type](#input\_instance\_type) | Instance type for the EC2 | `string` | `"t3.micro"` | no |
...
| <a name="input_public_subnets_ids"></a> [public\_subnets\_ids](#input\_public\_subnets\_ids) | List of public subnets | `list(string)` | n/a | yes |
...
| <a name="input_vpc_id"></a> [vpc\_id](#input\_vpc\_id) | VPC ID of the VPC. | `string` | n/a | yes |
...
| <a name="output_lb_dns_name"></a> [lb\_dns\_name](#output\_lb\_dns\_name) | Public DNS of the load balancer |
<!-- END_TF_DOCS -->